...
class MergedNewsFinBERTPredictor:
    def __init__(self, csv_path, finbert_model="ProsusAI/finbert", hf_token=None):
        """
        ...
        Args:
            ...
            finbert_model: The FinBERT model to use (default: "ProsusAI/finbert")
        ...
        # Set sequence length for merged news (slightly longer than full text to accommodate title)
        self.max_merged_length = 512
        
        # Create directories for visualizations with "Merged" prefix
        self.cnn_viz_dir = 'Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_cnn/COP'
        self.lstm_viz_dir = 'Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_lstm/COP'
        os.makedirs(self.cnn_viz_dir, exist_ok=True)
        os.makedirs(self.lstm_viz_dir, exist_ok=True)
        os.makedirs('Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_summary/COP', exist_ok=True)
    ...
    def get_finbert_embeddings(self, texts, max_length):
        ...
        batch_size = 50  # Adjust based on available GPU memory
    ...
    def split_data(self, layer, label_col, model_type):
        ...
        Extract FinBERT embeddings for merged news text.
    ...
    def create_cnn_model(self, input_shape):
        ...
        model.compile(
            optimizer=Adam(learning_rate=0.00005),  # Lower learning rate for stability with longer sequences
    ...
    def create_lstm_model(self, input_shape):
        ...
        # LSTM layer with moderate complexity
    ...
    def run_all_combinations(self):
        ...
        # Define model types and label columns
    ...
    def create_summary_visualization(self, summary_data):
        ...
        plt.ylabel('Score')
        plt.title('Performance Comparison of Models with Merged News and FinBERT')
        ...
        save_path = os.path.join('Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_summary/COP', "overall_performance_comparison.png")
    ...
    def _create_model_type_visualization(self, data, model_type):
        ...
        plt.ylabel('Score')
        plt.title(f'Performance of {model_type} Models with Merged News and FinBERT')
        ...
        # Save the visualization
        save_path = os.path.join('Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_summary/COP', f"{model_type.lower()}_performance_comparison.png")
        plt.savefig(save_path)
    ...
    def _create_layer_visualization(self, df, title_prefix):
        ...
        plt.title(f'{title_prefix} Accuracy by Combination and Layer with Merged News and FinBERT')
        ...
        plt.title(f'{title_prefix} AUC by Combination and Layer with Merged News and FinBERT')
        ...
        save_path = os.path.join('Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_summary/COP', f"{filename}_layer_performance.png")
        plt.savefig(save_path)
...
if __name__ == "__main__":
    ...
    for directory in ['Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_cnn/COP', 
                      'Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_lstm/COP', 
                      'Climate_news_second_database/Merged_FinBERT_P_CNN_LSTM/visualizations_summary/COP']:
    ...
    predictor = MergedNewsFinBERTPredictor(csv_path, finbert_model="ProsusAI/finbert", hf_token=hf_token)
    
    # Run the complete analysis
    predictor.load_data().define_time_windows().run_all_combinations()
    
    print("\nAnalysis complete! Results saved to 'Merged_FinBERT_CNN_LSTM' directory.")