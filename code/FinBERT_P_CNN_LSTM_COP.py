...
class ClimateNewsFinBERTPredictor:
    def __init__(self, csv_path, finbert_model="ProsusAI/finbert", hf_token=None):
        ...
        self.cnn_viz_dir = 'Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_cnn/COP'
        self.lstm_viz_dir = 'Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_lstm/COP'
        os.makedirs(self.cnn_viz_dir, exist_ok=True)
        os.makedirs(self.lstm_viz_dir, exist_ok=True)
        os.makedirs('Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_summary/COP', exist_ok=True)
    ...
    def create_summary_visualization(self, summary_data):
        ...
        plt.ylabel('Score')
        plt.title('Performance Comparison of CNN Models with FinBERT')
        ...
        save_path = os.path.join('Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_summary/COP', "cnn_performance_comparison.png")
        ...
        plt.ylabel('Score')
        plt.title('Performance Comparison of LSTM Models with FinBERT')
        ...
        # Save the visualization
        save_path = os.path.join('Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_summary/COP', "lstm_performance_comparison.png")
        plt.savefig(save_path)
    ...
    def _create_model_layer_visualization(self, layer_data, model_type):
        ...
        plt.title(f'{model_type} Accuracy by Model Combination and Layer with FinBERT')
        ...
        plt.title(f'{model_type} AUC by Model Combination and Layer with FinBERT')
        ...
        # Save the visualization
        save_path = os.path.join('Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_summary/COP', f"{model_type.lower()}_layer_performance.png")
        plt.savefig(save_path)
...
if __name__ == "__main__":
    ...
    for directory in ['Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_cnn/COP', 'Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_lstm/COP', 
                      'Climate_news_second_database/FinBERT_P_CNN_LSTM/visualizations_summary/COP']:
    ...
    predictor = ClimateNewsFinBERTPredictor(csv_path, finbert_model="ProsusAI/finbert", hf_token=hf_token)
    
    # Run the complete analysis
    predictor.load_data().define_time_windows().run_all_combinations()
    
    print("\nAnalysis complete! Results saved to 'FinBERT_P_CNN_LSTM' directory.")